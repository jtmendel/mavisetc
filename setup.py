    ...
    setup(
        ...
        package_data={"": ["README.md", "LICENSE"],
                      "mavisetc": ["mavisetc/data/mavis/PSF_PC10_2024-06-27.fits",
							  ...
							  "mavisetc/data/lamp_templates/new_composite_Ne_flux.csv",
                              ...
                              "mavisetc/data/lamp_templates/LDLS_400um_Core_to_Focus_Etalon.csv",
                              "mavisetc/data/lamp_templates/LDLS_400um_Core_to_Focus.csv",
