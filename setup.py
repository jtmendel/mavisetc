...
if __name__ == "__main__":
    ...
    setup(
        ...
        package_data={"": ["README.md", "LICENSE"],
                      "mavisetc": ["mavisetc/data/mavis/PSF_PC10_2024-06-12.fits",
                              "mavisetc/data/mavis/PSF_PC25_2024-06-12.fits",
                              "mavisetc/data/mavis/PSF_PC50_2024-06-12.fits",
                              "mavisetc/data/mavis/PSF_PC75_2024-06-12.fits",
                              "mavisetc/data/mavis/PSF_PC90_2024-06-12.fits",
                              ...
                              "mavisetc/data/etalon/EQ99X_flux_100um_fibre.csv",
                              "mavisetc/data/etalon/SLS_Reflectivity_Etatlon_80um.csv",
							  ...
							  "mavisetc/data/lamp_templates/GS_ThAr_1dspec.csv",
							  "mavisetc/data/lamp_templates/Newport_Ar_1dspec.csv",
							  "mavisetc/data/lamp_templates/Newport_HgAr_1dspec.csv",
							  "mavisetc/data/lamp_templates/Newport_Kr_1dspec.csv",
							  "mavisetc/data/lamp_templates/Newport_Ne_1dspec.csv",
							  "mavisetc/data/lamp_templates/Photron_ThAr_1dspec.csv",
                              "mavisetc/data/lamp_templates/Etalon_EQ99_HRBlue.csv",
						      "mavisetc/data/lamp_templates/Etalon_EQ99_LRBlue.csv",
						      "mavisetc/data/lamp_templates/Etalon_EQ99_HRRed.csv",
						      "mavisetc/data/lamp_templates/Etalon_EQ99_LRRed.csv",
